...
import { Download, ArrowRight, Sparkles, X } from "lucide-react";
        ...
        <div className="bg-gradient-to-r from-purple-600 to-pink-500 rounded-3xl overflow-hidden shadow-xl">
          <div className="px-8 py-16 md:p-16">
            <div className="flex flex-col md:flex-row items-center">
              <motion.div
                className="w-full md:w-2/3 mb-10 md:mb-0 md:pr-8"
                initial={{
                  opacity: 0,
                  x: -20,
                }}
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  <motion.button
                    ...
                    className="flex items-center justify-center px-8 py-4 bg-white text-purple-600 font-medium rounded-lg shadow-lg hover:shadow-xl"
                    whileHover={{
                      scale: 1.03,
                    }}
                    whileTap={{
                  ...
                  <motion.button
                    onClick={() => setShowModal(true)}
                    className="flex items-center justify-center px-8 py-4 border-2 border-white text-white font-medium rounded-lg hover:bg-white/10"
                    whileHover={{
                      scale: 1.03,
                    }}
                    whileTap={{
                          ...
                          <div className="flex items-start">
                            ...
                            <div>
                              ...
                              <p className="text-white text-sm">
                                {item === 1 &&
                                  "My skin has never looked better! The personalized routine was exactly what I needed."}
                                {item === 2 &&
                                  "Finally found products that work for my sensitive skin. Thank you Seraface!"}
                                {item === 3 &&
                                  "The AI analysis was spot on. Cleared my acne in just 3 weeks!"}
                              </p>
                            </div>
                          </div>
                        </div>
