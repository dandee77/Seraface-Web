  ...
  const steps = [
    {
      ...
      description:
        "Answer a few questions about your skin type, concerns, and goals to help our AI understand your needs.",
      image: "form.webp",
    },
    {
      title: "Scan Your Face",
      description:
        "Take a selfie to allow our advanced AI to analyze your skin conditions and identify specific concerns.",
      image: "scan.avif",
    },
    {
      title: "Get Personalized Recommendations",
      description:
        "Receive a curated list of products and a custom routine tailored specifically to your skin needs.",
      image: "recos.png",
    },
  ];
  return (
    <section className="py-24 bg-white" id="app-showcase">
                  ...
                  {[1, 2, 3].map((item) => (
                    ...
                    >
                      ...
                      <p className="text-gray-700">
                        {index === 0 &&
                          item === 1 &&
                          "Simple questionnaire to understand your skin"}
                        {index === 0 &&
                          item === 2 &&
                          "Identify allergies and sensitivities"}
                        {index === 0 &&
                          item === 3 &&
                          "Set your skincare goals and budget"}
                        {index === 1 &&
                          item === 1 &&
                          "Advanced computer vision technology"}
                        {index === 1 &&
                          item === 2 &&
                          "Detects acne, wrinkles, dark spots, and more"}
                        {index === 1 &&
                          item === 3 &&
                          "Privacy-focused analysis keeps your data secure"}
                        {index === 2 &&
                          item === 1 &&
